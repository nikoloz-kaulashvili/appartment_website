...
<section class="footer-four pt-80">
    <div class="container">
        <div class="pt-5 row">
            ...
            <div class="col-md-4 pl-30 pr-30 b-l-r">
            ...
            <div class="col-md-4 pl-30">
                <div class="mt-20 footer-cont footer-logo subs">
                    <h4>
                        Get the best viral<br />
                        strories straight into<br />
                        your inbox!
                    </h4>
                    <div class="news-f1">
                        <div id="resultsubscription">
                            <span class="seccess1" style="color: #ffffff">Mail Sent. Thank you, we will contact you
                                shortly.</span>
                            <span class="error1" style="color: #ffffff">Mail was not Sent.</span>
                        </div>
                        <form id="my-form-newsletter" action="/contact-store" method="post" class="form-event">
                            @csrf
                            <input type="email" name="email" placeholder="Email" class="fill form-control" />
                            <button class="btn upcase" type="submit" name="submitnewsletter">
        ...
        <div class="row">
            <div class="col-md-12 border-t-b">
                <ul class="social-t fl-left">
                    <li>
                        <a href="#" class="facebook-change-co"><i class="fa fa-facebook-f"></i></a>
                    </li>
                    <li>
                        <a href="#" class="twitter-change-co"><i class="fa fa-twitter"></i></a>
                    </li>
                    <li>
                        <a href="#" class="pinterest-change-co"><i class="fa fa-pinterest"></i></a>
                    </li>
                    <li>
                        <a href="#" class="linkedin-change-co"><i class="fa fa-linkedin"></i></a>
                    </li>
                </ul>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <button type="button" class="close modal-close" data-dismiss="modal">
                <img src="/website/images/cancel.png" alt="" class="cl-b" />
            </button>
            <div class="modal-body">
                <div class="min-top-modal">
                    ...
                    <div class="right-m-text">
                        <h3>
                            <a href="pro-details.html">Ample Apartment At Last Floor</a>
                        </h3>
                ...
                <div class="modal-agent">
                    <span class="left-m-i">
                        <a href="pro-details.html">
                            <img src="/website/images/t2.png" alt="" class="img-fluid" />
                        </a>
                    </span>
                    <div class="right-m-text">
                        <h3><a href="pro-details.html">Joana Williams</a></h3>
                ...
                <div class="modal-form">
                    <form>
                        ...
                        <div class="mb-0 form-group">
                            <button class="mod-b">Send Message</button>
                        </div>
                    </form>
                </div>
            </div>
