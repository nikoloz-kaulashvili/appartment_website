                ...
                <div class="col-md-5">
                    <div class="mail-send">
                        <ul>
                            <li>
                                <a class="mr-4" href="">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" fill="#fff
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="menu-wrap">
                        <nav class="menu-nav">
                            <div class="logo">
                                <a href="/"><img src="/website/images/logo.png" alt=""></a>
                            </div>
                            ...
                            <div class="header-action d-none d-md-block">
                                <ul>
                                    <li class="header-btn">
                                        <a href="tel:+995557582750" class="animation-cer btn-call">
                                    ...
                                    <li>
                                        <a href="login.html">
                                            <span class="icon-call">
                                                <img src="/website/images/user-o.png" alt="">
                                            </span>
                                            <div class="cont-con">
                                                Login / Register
                                            </div>
