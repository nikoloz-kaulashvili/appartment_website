                                ...
                                <div class="col-md-4">
                                    <div class="min-f-box">
                                        <div class="img-f-b">
                                            ...
                                            <span class="fav add-wishlist" data="{{$appartment->id}}"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-heart" viewBox="0 0 16 16">
